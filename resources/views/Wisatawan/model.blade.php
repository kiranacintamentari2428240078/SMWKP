...
@section('title', 'Restoran Model Terbaik | SMWKP')
...
<header class="relative pt-20 h-[614px] min-h-[500px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBhwU5rGeIID43DxNLZsfdVH3TYfrUd62sg2e3Gx2cLxawjDJkyPONcjrHBoRv_IP2YpJzCoIatjHBRWofggpzd3oYO-Gu9iSMZFHgiKeGqSFoXLDWg9tHUwxWWUZdyy8k1fA1GrB-K5mlWc3Hr9D7h3rB_TcV3zy3ydq0I1dQ9mu96rbP_QNsvypGWE8lMQ70BOBZbEAzw8C-VB8k-Nv42pj-UVrb_TPEl8iWKnNZ4kpEY-yXw_3OfuB0HujszpGL1YmiFBBPXnkxC">
    ...
    <div class="relative z-10 px-margin-desktop container mx-auto">
        <div class="max-w-2xl">
            ...
            <h1 class="font-display-lg text-display-lg text-white mb-6 leading-tight">Restoran Model Terbaik di Palembang</h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant mb-10 max-w-lg">
                Nikmati perpaduan gurihnya tahu dalam adonan ikan dengan kuah kaldu udang yang otentik, disajikan dalam suasana elegan.
            </p>
        </div>
    </div>
</header>
    ...
    <div class="flex-1">
        <div class="flex justify-between items-center mb-10">
            <div>
                ...
                <p class="text-on-surface-variant">Rekomendasi terbaik untuk hidangan Model</p>
            </div>
        </div>
