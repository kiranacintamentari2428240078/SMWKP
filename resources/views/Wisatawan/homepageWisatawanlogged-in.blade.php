...
@section('title', 'Beranda Wisatawan | SMWKP')
...
<main>
    ...
    <section class="relative h-screen min-h-[700px] flex items-center justify-center">
        ...
        <div class="relative z-10 w-full max-w-4xl px-margin-mobile text-center">
            ...
            <form action="{{ route('wisatawan.katalog') }}" method="GET" class="glass-effect p-2 flex flex-col md:flex-row gap-2 max-w-3xl mx-auto shadow-2xl rounded-full w-full">
                <div class="flex-1 flex items-center px-4 bg-surface-container-lowest border border-outline-variant/30 rounded-full">
                    ...
                    <input name="search" class="bg-transparent border-none focus:ring-0 text-on-surface w-full py-4 font-body-md outline-none focus:outline-none" placeholder="Cari Nama Tempat, Menu, atau Kategori..." type="text">
                </div>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-2">
                        ...
                        <div class="flex items-center text-primary">
                            ...
                            <span class="ml-1 text-on-surface font-label-md">{{ number_format($r->reviews_avg_rating ?? 5.0, 1) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-4 border-t border-white/5">
                        <div class="flex items-center gap-1 text-on-surface-variant">
                            ...
                            <span class="text-label-md">{{ Str::limit($r->alamat, 25) }}</span>
                        </div>
