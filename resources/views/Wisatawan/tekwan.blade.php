...
@section('title', 'Restoran Tekwan Terbaik | SMWKP')
...
<header class="relative pt-20 h-[614px] min-h-[500px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCYBjDNLDlRAvtRPIXjoYM_fizHr_Vh59C_I2mPftX1H2oUsX5SxOf3k5dGlf6YxTIWewwI_ZJmQ0klV_M1CDCFtWDPCByH-CjAp5bA1aTJmJtV370NLLCn9NfbGFCA6c7Tvxd3iGTaYCR0sw2qzySmsFPyT1RS4SxvyQ2Dgvy43jD2XAZaIAMIq8MAocp8n9MuAuVHhZBfKY39lENU2NPqub3UbitmVVmw4splniJSSmu_Cy--CHYOu3QsEa_zSleIvVM4pB3fOzcm">
    ...
    <div class="relative z-10 px-margin-desktop container mx-auto">
        <div class="max-w-2xl">
            ...
            <h1 class="font-display-lg text-display-lg text-white mb-6 leading-tight">Restoran Tekwan Terbaik di Palembang</h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant mb-10 max-w-lg">Nikmati kesegaran kuah kaldu udang dan tekstur kenyal bola ikan khas dari para legenda kuliner Bumi Sriwijaya.</p>
        </div>
    </div>
</header>
    ...
    <div class="flex-1">
        <div class="flex justify-between items-center mb-10">
            <div>
                ...
                <p class="text-on-surface-variant">Rekomendasi terbaik untuk hidangan Tekwan</p>
            </div>
        </div>
