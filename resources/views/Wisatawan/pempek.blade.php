...
@section('title', 'Restoran Pempek Terbaik | SMWKP')
...
<header class="relative pt-20 h-[614px] min-h-[500px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBGiS7a-C4gy3ACygzNTW2Gy7g-v7PQoD4Jz06JuUsRKyP1iVOB1eUKmbUtA9JtQHivP7FtpWYLLZiolKDEcvz0mxh2cwhBwgraj1uj6kfAxk6RCzLtL8DV0NUHGUP4jXBYyMntgI1ymybdCB4c1inhGnoizdV0EnALh7hfIsqQ7X9e6iXjlalH3b7Pk0Q3r2YgLxs9lw0G9V7h8GjBY6J0jawv60h3S_L49L7N1RoshSY5yxYy-ZZ8Hoo-YjOa0El7OMZ5rRI_pHdU">
    ...
    <div class="relative z-10 px-margin-desktop container mx-auto">
        <div class="max-w-2xl">
            <h1 class="font-display-lg text-display-lg text-white mb-6 leading-tight">Restoran Pempek Terbaik di Palembang</h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant mb-10 max-w-lg">Temukan kelezatan otentik warisan budaya Palembang. Dari kapal selam hingga adaan, jelajahi kurasi restoran dengan cita rasa ikan belida yang melegenda.</p>
        </div>
    </div>
</header>
...
<main class="max-w-container-max mx-auto px-margin-desktop py-20 flex flex-col md:flex-row gap-gutter">
    ...
    <div class="flex-1">
        <div class="flex justify-between items-center mb-10">
            <div>
                <h2 class="font-headline-lg text-headline-lg text-white">Menampilkan {{ $restaurants->count() }} Restoran</h2>
                <p class="text-on-surface-variant">Rekomendasi terbaik untuk hidangan Pempek</p>
            </div>
        </div>
