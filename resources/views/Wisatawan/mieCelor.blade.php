...
@section('title', 'Restoran Mie Celor Terbaik | SMWKP')
...
<header class="relative pt-20 h-[614px] min-h-[500px] flex items-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida/AP1WRLtWuhmN61BADpJw071R8EJb3Eaz05HOqBI98ZYx6cQXHpbV6mC6UYc8acSqT5uAr6flazQpwhA6TdXOPjfcF_eF9ra1Si-WRHg_5_433Wuw4U0meaaL5K9TfhsrGeeYG1z-ntQbEghgJjtHR5LQmzroZxBH-pByharRlWp3JkapykGuKAXOm4G1IFm_NiHOMGyStKhnmVLGLh1mEo1FJDpwaljFBEVRtukXUztxtJds8-rxosSC_gi_YrDT">
    ...
    <div class="relative z-10 px-margin-desktop container mx-auto">
        <div class="max-w-2xl">
            ...
            <h1 class="font-display-lg text-display-lg text-white mb-6 leading-tight">Restoran Mie Celor Terbaik di Palembang</h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant mb-10 max-w-lg">Nikmati kelezatan mie kuning tebal dengan siraman kuah kental kaldu udang yang gurih dan kaya rempah khas Palembang.</p>
        </div>
    </div>
</header>
...
<main class="max-w-container-max mx-auto px-margin-desktop py-20 flex flex-col md:flex-row gap-gutter">
    ...
    <div class="flex-1">
        <div class="flex justify-between items-center mb-10">
            <div>
                <h2 class="font-headline-lg text-headline-lg text-white">Menampilkan {{ $restaurants->count() }} Kedai Mie Celor</h2>
                <p class="text-on-surface-variant">Rekomendasi terbaik untuk hidangan Mie Celor</p>
            </div>
        </div>
